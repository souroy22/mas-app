...
const AddTest = ({close, fetch, projectId}) => {
        ...
        <Grid container justify="center" spacing={4}>
            <Grid item lg={10} xs={12}>
                <Grid container justify="flex-start">
                    <Typography variant="h5" style={{textDecoration: 'underline'}}>New Test</Typography>
                </Grid>
            </Grid>
            ...
            <Grid item lg={10} xs={12}>
                ...
                }} fullWidth label="Name" variant="outlined" size="small" value={subject} />
            </Grid>
            ...
            <Grid item lg={10} xs={12} container justify="space-between" spacing={2}>
                ...
                <Grid item>
                    ...
                    }} label="Owner" variant="outlined" size="small" value={assignee} />
                </Grid>
            </Grid>
